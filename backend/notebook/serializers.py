...
class NotebookSerializer(serializers.ModelSerializer):
    ...
    experiment_count = serializers.IntegerField(source="experiments.count", read_only=True)
    ...
    def get_permissions(self, obj):
        ...
        return {action: user_can_notebook(user, obj, action) for action in ["read", "write", "comment", "review", "lock"]}
...
class ExperimentSerializer(serializers.ModelSerializer):
    ...
    def get_permissions(self, obj):
        user = self.context["request"].user
        return {action: user_can_notebook(user, obj.notebook, action) for action in ["read", "write", "comment", "review", "lock"]}

    def get_assignee_usernames(self, obj):
        return list(obj.assignees.values_list("username", flat=True))
