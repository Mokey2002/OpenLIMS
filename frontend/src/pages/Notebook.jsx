...
export default function NotebookPage() {
  ...
  async function toggleTemplate(template) {
    try {
      const updated = await apiPatch(`/api/experiment-templates/${template.id}/`, { active: !template.active });
      ...
      <Tab.Content>
        ...
        <Tab.Pane eventKey="templates">
          <TemplateManagement
            ...
            onEdit={setDesignTemplate} onToggle={toggleTemplate} onUse={(template) => { setExperimentForm({ source: "template", template: String(template.id), title: "", assignees: [] }); setShowExperimentModal(true); }}
          />
        </Tab.Pane>
      </Tab.Content>
